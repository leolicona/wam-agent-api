...
export const corsConfig = {
  ...
  development: {
    origin: ['http://localhost:3000', 'http://localhost:5173', 'http://localhost:8080', 'https://webapp-unalana.leolicona-dev.workers.dev'],
...
export const corsMiddleware = cors(corsConfig.development);
